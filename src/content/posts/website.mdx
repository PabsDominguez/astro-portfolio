...
I still like having a home online, so I wanted to see what the latest in web tech had to offer. As it turns out, a lot of the things that took so much effort to configure in 2022, _just work_ in 2026, even without the help of magic intelligence in the sky.
...
My only goal for the v3 revision was to _simplify, simplify, simplify_. How many lines of code do I need for a landing page + blog, really?
...
Does this _actually_ matter? No. Definitely no. But it makes me happy.
...
I also love the simplification of [Tailwind v4](https://tailwindcss.com/), letting us drop not one, but _two_ root-level configs.
