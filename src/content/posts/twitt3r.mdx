...
import hardhatTests from '../images/hardhat-tests.webp';
import rainbowkit from '../images/rainbowkit.webp';
import ensProfile from '../images/ens-profile.webp';

<img src="https://github.com/maxpetretta/twitt3r.xyz/blob/master/demo.gif?raw=true" alt="A quick 60 second demo of twitt3r.xyz" width="650" height="458" loading="eager" fetchpriority="high" class="mx-auto" />
...
<Image src={hardhatTests} alt="Terminal output of running hardhat tests on Twitt3r" />
...
<Image src={rainbowkit} alt="A screenshot of the RainbowKit UI" />
...
<Image src={ensProfile} alt="A screenshot of the author's ENS profile page" />
