...
import flatLayTravel from '../images/flat-lay-travel.webp';
import flatLayEdc from '../images/flat-lay-edc.webp';
import aeronaut from '../images/aeronaut.webp';
import techonaut from '../images/techonaut.webp';
import synik from '../images/synik.webp';
import peakdesign from '../images/peakdesign.webp';
import dragonfly from '../images/dragonfly.webp';
import shadowguide from '../images/shadowguide.webp';

<Image src={backpack} alt="A photo of a backpack on a busy city street, courtesy of OpenAI's DALL-E" loading="eager" fetchpriority="high" />
...
<Image src={flatLayTravel} alt="A flay lay photo of my primary travel items" />
...
<Image src={flatLayEdc} alt="A flay lay photo of my primary every day carry items" />
...
<Image src={aeronaut} alt="A comparison image between the Tom Bihn Aeronaut holding EDC and travel items" />
...
<Image src={techonaut} alt="A comparison image between the Tom Bihn Techonaut holding EDC and travel items" />
...
<Image src={synik} alt="A comparison image between the Tom Bihn Synik holding EDC and travel items" />
...
<Image src={peakdesign} alt="A comparison image between the Peak Design Travel Backpack holding EDC and travel items" />
...
<Image src={dragonfly} alt="A comparison image between the ULA Dragonfly holding EDC and travel items" />
...
<Image src={shadowguide} alt="A comparison image between the Tom Bihn Shadow Guide holding EDC and travel items" />
