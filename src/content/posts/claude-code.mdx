...
import claudeStats from "../images/claude-stats.webp";

I would be lying if I said I write 50% of the code that I ship into production, these days.

I would _still_ be lying if I said I write 20% of that code.

No, I am handwriting less than 10% of what I deploy. This should end in disaster - a giant ball of spaghetti. But somehow, it's working. And how fast I can ship is only _increasing_.
...
Agent mode was _okay_, at best. Each line it produced had to be scrutinized. The LLM was most helpful as a quick documentation lookup, or as an intelligent "find-and-replace" for boilerplate.
...
Meanwhile, [vibecoding](https://x.com/karpathy/status/1886192184808149383) was gaining momentum. I kept writing my code by hand. After all, for the first five years of my career there _was no other way_. The best method I had found to learn programming (or anything, really) was to take something apart piece-by-piece, and understand every word of syntax needed to make that product work.
...
My rate of commits has roughly doubled, and we can prototype, test, and ship new features for Bracky[^3] almost daily. The hardest part is no longer engineering, but actually deciding _what_ to build.
